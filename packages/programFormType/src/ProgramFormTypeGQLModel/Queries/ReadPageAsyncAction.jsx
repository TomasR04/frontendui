...
query programFormPage($skip: Int, $limit: Int, $orderby: String, $where: ProgramFormTypeInputFilter) {
  programFormPage(skip: $skip, limit: $limit, orderby: $orderby, where: $where) {
  ...Large
}
}
`
