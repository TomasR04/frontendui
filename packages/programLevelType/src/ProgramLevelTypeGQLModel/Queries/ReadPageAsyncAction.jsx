...
query programLevelPage($skip: Int, $limit: Int, $orderby: String, $where: ProgramLevelTypeInputFilter) {
  programLevelPage(skip: $skip, limit: $limit, orderby: $orderby, where: $where) {
  ...Large
}
}
`
