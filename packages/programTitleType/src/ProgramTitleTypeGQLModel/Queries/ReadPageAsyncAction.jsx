...
query programTitlePage($skip: Int, $limit: Int, $orderby: String, $where: ProgramTitleTypeInputFilter) {
  programTitlePage(skip: $skip, limit: $limit, orderby: $orderby, where: $where) {
  ...Large
}
}
`
